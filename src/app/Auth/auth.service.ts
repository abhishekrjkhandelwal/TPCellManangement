...
export class AuthService {
  ...
  login(email: string, password: string) {
    ...
    admin(adminLogin: boolean) {
           console.log('aaaaaaaaaaaaaaaadminlogin' + adminLogin);
           this.loginadmin = adminLogin;
    }

    adminheader() {
      console.log('adminlllllllllllllllllogin' + this.loginadmin);
